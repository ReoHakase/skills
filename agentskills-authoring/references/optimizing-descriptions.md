...
> Source: [https://agentskills.io/skill-creation/optimizing-descriptions](https://agentskills.io/skill-creation/optimizing-descriptions)  
...
If you're using a script like the one [above](https://agentskills.io/skill-creation/optimizing-descriptions#running-multiple-times), you can split your queries into two files — `train_queries.json` and `validation_queries.json` — and run the script against each one separately.
